...
def save_intermediate(cube, name, out_dir, async_format, synchronous, *, to_skip: list|None = None):
    ...
    with_save_result = cube.save_result(format=async_format)
...
def main(max_distance_to_cloud_m, temporal_score_stddev, t_start, t_end_excl, s3_composite_interval, target_interval, bbox, s3_data_bands, s2_data_bands, fused_band_names, output_dir, save_intermediates, synchronous, skip_intermediates):
    ...
    s3_cloud_mask = save_intermediate(s3_cloud_mask, "s3_cloud_mask.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    ...
    s3_distance_to_cloud = save_intermediate(s3_distance_to_cloud, "s3_distance_to_cloud.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    s3_distance_score = compute_distance_score(s3_distance_to_cloud, max_distance_to_cloud_s3_px)
    s3_distance_score = save_intermediate(s3_distance_score, "s3_distance_score.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    ...
    s3_composite_data_bands = save_intermediate(s3_composite_data_bands, "s3_composite_data_bands.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)

    # s2 pre processing
    s2_cloud_mask = compute_cloud_mask_s2(s2_flags)
    s2_cloud_mask = save_intermediate(s2_cloud_mask, "s2_cloud_mask.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    s2_cloud_mask_coarse = s2_cloud_mask.resample_cube_spatial(s3_bands, method="near")
    s2_cloud_mask_coarse = save_intermediate(s2_cloud_mask_coarse, "s2_cloud_mask_coarse.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    ...
    s2_distance_to_cloud = save_intermediate(s2_distance_to_cloud, "s2_distance_to_cloud.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)

    s2_distance_score = compute_distance_score(s2_distance_to_cloud, max_distance_to_cloud_s3_px)
    s2_distance_score = save_intermediate(s2_distance_score, "s2_distance_score.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    ...
    s3_composite_target_interp = save_intermediate(s3_composite_target_interp, "s3_composite_target_interp.nc", out_dir=output_dir, async_format="netcdf", synchronous=synchronous, to_skip=skip_intermediates)
    ...
    # s2/3 aggregate
    s2_bands_dtc_merge = s2_bands.merge_cubes(s2_distance_score)
